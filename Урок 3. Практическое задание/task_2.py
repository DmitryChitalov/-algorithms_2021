...
# Алгоритм не поддерживает проверку на уникальность имени пользователя. При двух одинаковых пользователях будет
# сопоставление с первым в выборке. По условиям задачи такие проверки не требуются, поэтому считаю, что ими можно
# пренебречь
