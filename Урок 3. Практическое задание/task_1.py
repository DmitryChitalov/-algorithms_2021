...
@timer
def operate_list_On(l):  # функция с линейной сложностью O(n)
...
@timer
def operate_list_On2(l):  # функция с квадратичной сложностью O(n^2)
    for i in range(len(l)):
...
@timer
def operate_dict_On(d):  # функция с линейной сложностью O(n)
    for i in d:
...
@timer
def operate_dict_On2(d):  # функция с квадратичной сложностью O(n^2)
    for i in d:
