...
хотя алгоритмическая сложность одинаковая. Связано также с пересчетом индексов последующих элементов 
как и в случае с insert.

- По функциям изменения значений элементов:
Скорость изменения значений одинакового количества элементов списка и словаря примерно одинакова и очень высокая, т.к. 
