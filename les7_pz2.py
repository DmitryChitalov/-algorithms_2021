...
# На большом количестве данных сортровка слиянием показывает достаточно высокие результаты:
# скорость уменьшается чуть больше чем на порядок, почти так же как и увеличивается кол-во данных
