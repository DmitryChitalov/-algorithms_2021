...
#  добавленных узлов дерева. Для проверки корректности построения дерева добавила атрибут path, куда пишется путь
#  размещения узла. В интерфейс дообавила еще метод поиска узла по значению
