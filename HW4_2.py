...
мемоизация нужна, и даже в этом случае, с одним вызовом, измерения показали, что с мемоизацией вариант быстрее чем без
мемоизации. Потому что, мемоизация реализована через  декоратор, который вычисляет кэш заранее.
