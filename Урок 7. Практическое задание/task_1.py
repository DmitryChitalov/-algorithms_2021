...
"""
Вывод:
Доработка алгоритма заключалась в том, что если за проход цикла не было ни одной перестановки - массив отсортирован
и мы выходим из цикла.
доработка алгоритма незначительно увеличила его эффективность, тк проходы по отсортированному массиву
происходят быстро и нет нужды переставлять элементы местами. Прирост составил менее 2%. 
Результаты замеров массива 100 элементов 1миллион повторений:
