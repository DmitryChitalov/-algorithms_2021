...
orig_list = [random.uniform(0, 50) for _ in range(10000)]

# замеры 10000
print("Замеры 10000 элементов: ",
      timeit.timeit(
          "merge_sort(orig_list[:])",
          globals=globals(),
          number=1000))
...
"""
Замеры 10 элементов:  0.04256780000000049
Замеры 100 элементов:  0.6141402999999999
Замеры 1000 элементов:  7.9394667
Замеры 10000 элементов:  98.5060383
Алгоритм хороший, но с увеличением количества элементов в массиве, значительно увеличивается время сортировки.
"""
