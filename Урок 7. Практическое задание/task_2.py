...
print(f'Исходный массив - {origin_list_10}')
print(f'Отсортированный массив - {sort_list_10}')
...
'''
1000 повторов:
Сортировка слиянием на массиве 10 элементов = 0.031250299999999995
Сортировка слиянием на массиве 100 элементов = 0.4144069
Сортировка слиянием на массиве 1 000 элементов = 5.849451800000001
'''