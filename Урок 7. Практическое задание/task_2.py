...
print(
    timeit.timeit(
        ...
        globals=globals(),
        number=1000))  # -> 0.01741749999999964
print()
...
print(
    timeit.timeit(
        "merge_sort(orig_list[:])",
        globals=globals(),
        number=1000))  # -> 0.2020010000000001
print()
...
print(
    timeit.timeit(
        "merge_sort(orig_list[:])",
        globals=globals(),
        number=1000))  # -> 2.917854899999999

'''
Результаты показали, что метод сортировки слиянием работает гораздо быстрее метода пузырька
'''