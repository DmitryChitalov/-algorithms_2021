...
'''
пример 3 по заполнению обычного словаря и OrderedDict.
из логов видно, что при заполнении двух структур одним и тем же набором данных,
обычный словарь в памяти занял 5.0 MiB, а OrderedDict 7.0 MiB, что менее эффективно.
'''
############################################################### Пример 3
