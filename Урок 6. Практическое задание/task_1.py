...
new_list = map(recursive_reverse, nums)
#
# nums = [random.randint(100, 999) for i in range(100)]

# def recursive_reverse(number, new_array = []):
#     for i in number:
#         if i == 0:
#             return ''
#         new_array.append(f'{str(i % 10)}{recursive_reverse(i // 10)}')
#         return new_array
# # {str(i % 10)}{recursive_reverse(i // 10)}
#
# print(recursive_reverse(nums))
