...
def reversed_num(num):
    """ Рекурсивная функция, формирующая из числа число обратное по порядку входящих в него цифр """
    # Базовый случай
    if num < 10:
        return num
    else:
        num_digit = num % 10
        return str(num_digit) + str(reversed_num(num // 10))
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f'перевернутое число: {reversed_num(NUM1)}')
    except ValueError:
