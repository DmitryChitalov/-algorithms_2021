...
LIST - 3.560406083
DEQUE - 3.5539665420000004

Добавление элемента в начало 10 000 повторов:
lst_in - 0.01694549999999939
deq_al - 0.0010301670000005814
LIST на 1545% дольше вставляет элемент в начало списка

Удаление элемент из начала 10 000 повторов:
lst_pop - 0.009840041
deq_pop - 0.0009943339999999995
LIST на 889% дольше удаляет элемент из начало списка

Добавление списка элементов в начало 10 000 повторов:
lst_extl - 0.009840041
deq_extl - 0.0009943339999999995
