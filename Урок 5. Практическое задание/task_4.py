...
Смысл исп-ть OrderedDict в Python 3.6 и более поздних версиях есть только ради совместимости кода с более старыми 
версиями Python без ущерба в скорости
Но если необходимости такой совместимости нет, то использование OrderedDict в Python 3.6 и более поздних версиях
отсутствует!
"""
