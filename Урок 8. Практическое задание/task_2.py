...
from sys import exit # для аварийного завершения программы
...
r.insert_left(4)
# r.insert_left(40) # проверяем левый эксепшн
print(r.get_left_child())
print(r.get_left_child().get_root_val())
r.insert_right(12)
# r.insert_right(1) # проверяем правый эксепшн
