...
"""
# Доработал, проверил, можно играться, но чтоб это прикрутить к Хаффману надо знатно потрудиться и много лишнего,
# что видно в задании 1. Но это все работает. Добавил еще проверку на вставку в конкретной ветке, что элемент
# меньше или больше узла т.е. в одном случае он вставляется и все сдвигается ниже, в другом выскакивает
# предупреждение.
