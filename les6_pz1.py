...
# Оптимизирую алгоритм с помощью генератора. Для данной ситуации, где нет необходимости хранить значения массива,
# он подходит хорошо, памяти опрактически не занимает, но вот по времени выиграть особо не удалось
#############################################################################################
...
#############################################################################################
# Вариант 3. Задание из Основ, используем слоты
class Date:
...
# Использование модуля numpy - переход к array вместо list - очевидная экономия памяти, но работает это только на
# больших объемах данных, при этом в ущерб времени, пусть и небольшой
