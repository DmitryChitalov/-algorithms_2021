...
print('1- на 100 запусков --', timeit.timeit("merge_sort(alist)",
                    setup="from __main__ import merge_sort, alist", number=100))
print('1- на 1000 запусков --', timeit.timeit("merge_sort(alist)",
                    setup="from __main__ import merge_sort, alist", number=1000))



print('2- на 100 запусков --', timeit.timeit("func_sort(alist)",
                    setup="from __main__ import func_sort, alist", number=100))
print('2- на 1000 запусков --', timeit.timeit("func_sort(alist)",
                    setup="from __main__ import func_sort, alist", number=1000))

#1---  проверка на 100 запусков -- 0.0008826370000001305
#1---  проверка на 1000 запусков -- 0.00899742399999992
#2---  проверка на 100 запусков -- 0.0009343809999999841
#2---  проверка на 1000 запусков -- 0.008889660999999993
