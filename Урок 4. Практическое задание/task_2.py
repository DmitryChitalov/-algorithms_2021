...
print(
    timeit(
        ...
        number=10000))
"""
Меморизация в этом примере не нужна.До запуска основной функции меморизация-декоратор заранее создает словарь.
...
Поэтому использование меморизации рационально только в случае многократного вызова функции.
"""
