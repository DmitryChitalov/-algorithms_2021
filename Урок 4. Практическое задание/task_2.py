...
# Вижу буквально следующее: в исходном коде не оптимизированный и мемоизированный алгоритмы
...
# в функцию число было разным, замеры скорости выполнения были бы другими (в порядке предположения)
...
# то (хоть мы этого еще не проходили, но...) есть вероятность утечки памяти(?)
...
# то поиск в кэше ничего не вернет. Уж если писать ключи в кэш, то оба: и прямой, и реверсивный
