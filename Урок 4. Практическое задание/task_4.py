...
"""
Сделал три варианта: "func_3" "func_4" "func_5" 
- func_3 почти идентична исходной "func_2" заменил цикл for на списковое включение, 
эффективность чуть увеличилась.
- func_4 быстрее за счет встроенной функции max() и аргумент "key", как вы и подсказывали а лекции,
по идее это самый быстрый вариант.
Но!!!
Исходя из замеров
- func_5 чуть быстрее за счет set() для исходного списка, там самым сокращая кол-во итераций в цикле 
по исходному списку
