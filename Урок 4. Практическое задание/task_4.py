...
# Первая функция выполняется быстрее,
# т.к. во второй тратиться время на создание нового списка.
# 3 вариант чуть быстрее за счет использования встроеных функций, за меньшее количества итераций.
