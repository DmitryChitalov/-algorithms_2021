...
#Самая быстрая функция в данном задании функция 1, несмотря на отсутсвие в коде встроеной функции и визуальную величину кода,
#Остальные функции выполнены в 1,5 и 2 раза дольше соответсвенно
