...
# В первой функции оптимизировала использование встроенной функции range.
...
# Надо сказать, что сначала я испробовала только LC, увеличение скорости произошло в 1,4 раза на большом списке,
# и уменьшение скорости на малом
# Но после оптимизации range скорость просто взлетела.
# Встроенные функции - самые оптимальные, надо их использовать как можно чаще и эффективнее
