...
"""
Взял ваш код разобрал несколько раз с помощью визуализаторов выполнения кода
оставил только коментарии которые мне больше нужны для пояснения
"""
"""
Разобрал ваш код в визуализаторах выполнения
Свой получился очень похожий
"""
