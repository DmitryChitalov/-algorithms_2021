...
def check_1(lst_obj):
    ...
    """
    lst_to_set = set(lst_obj)  # O(n) (линейная) зависит от длинны аргумента
...
def check_2(lst_obj):
    ...
    """
    for j in range(len(lst_obj)):          # O(n**1) (линейная)
        if lst_obj[j] in lst_obj[j+1:]:    # O(n**2) (квадратичная) так как есть два неизвестных числа [i] Правильно?
...
def check_3(lst_obj):
    ...
    for i in range(len(lst_obj) - 1):        # O(n**1)  (линейная)
        if lst_copy[i] == lst_copy[i+1]:     # O(n**2) (квадратичная) так как есть два неизвестных числа [i] Правильно?
            return False                     # O(1) (константная)
    return True                              # O(1) (константная)
