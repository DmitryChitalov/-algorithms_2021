...
class BinaryTree:
    ...
    def insert_left(self, new_node):
        try:
            if new_node > self.root:
                print('Данное число не может быть добавленно так как оно больше корня и его нужно вставить в правую часть')
    ...
    def insert_right(self, new_node):
        try:
            if new_node < self.root:
                print('Данное число не может быть добавленно так как оно меньше корня и его нужно вставить в правую часть')
            # если у узла нет левого потомка
