...
if __name__ == '__main__':
    ...
    my_queue.to_queue('выкинуть мусор',
                      'decided_task')  # перемещение задачи в 'revision_task' и удаление задачи из очереди "task"

    print(my_queue.task)  # проверка очереди
    print(my_queue.decided_task)  # проверка очереди

    my_queue.to_queue('проснутся', 'decided_task',
                      False)  # попытка перемещение задачи в 'revision_task' и удаление задачи из очереди "task", с атрибутом False
