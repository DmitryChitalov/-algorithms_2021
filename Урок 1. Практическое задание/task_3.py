...
profit = sorted(company_profit.values(), reverse = True)  # O(n log n)
for key in company_profit:                                # O(n)
    for i in range(0, 3):                                 # O(n)
...
new_dict = {value: key for key, value in company_profit.items()}    # O(n)
my_list = []                                                        # O(n)
for key in new_dict:                                                # O(n)
    my_list.append(key)                                             # O(1)
for r in range(len(my_list)-1):                                     # O(n)
    for i in range(len(my_list)-1-r):                               # O(n)
