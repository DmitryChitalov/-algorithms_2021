...
1) для каждого выражения вместо !!! укажите сложность этого выражениядля каждого выражения вместо !!! укажите сложность этого выражения.
...
def check_3(lst_obj):
    ...
    Сложность: O(nlogn) - линейно-логарифмическая сложность
    """
